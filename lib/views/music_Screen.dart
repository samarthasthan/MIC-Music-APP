...
import 'package:micmusic/views/page1.dart';
                      ...
                      children: [
                        IconButton(
                            ...
                            icon: Icon(Icons.shuffle,
                                color: iconColor, size: 30.w)),
                        IconButton(
                            onPressed: () {},
                            icon: Icon(Icons.skip_previous_outlined,
                                color: iconColor, size: 35.w)),
                        TextButton(
                            onPressed: () {},
                            child: Icon(
                              Icons.play_circle,
                        ...
                        IconButton(
                            onPressed: () {},
                            icon:
                                Icon(Icons.loop, color: iconColor, size: 35.w)),
                      ],
                    ),
                  )
                ],
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
        style: ElevatedButton.styleFrom(
            foregroundColor: Colors.black, backgroundColor: colour1),
        onPressed: () {
              ...
              return Column(
                children: [
                  ...
                  AlertDialog(
                    ...
                    buttonPadding: EdgeInsets.all(10.w),
                    backgroundColor: Color(0xFFCBFB5E),
                    title: Text(
                      text2,
                      style: TextStyle(
